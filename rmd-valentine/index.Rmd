...
meta() %>%
  meta_description(
    "How to use YAML, parameters, and strings to make your R Markdown documents better with glue and knitr engines."
  ) %>% 
  meta_name("github-repo" = "apreshill/talks") %>% 
  meta_viewport() %>% 
  meta_social(
    title = "Made with yarn, strings, and glue: An R Markdown valentine for you",
