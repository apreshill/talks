...
```{r recipe1rev, echo = FALSE, out.width = '70%'}
ggplot(ratings_bonanza1, aes(x = ep_id, y = viewers_7day, 
...
```{r lines, echo = FALSE, out.width='70%'}
...
```{r facetlinesrev, echo = FALSE, out.width='60%'}
ggplot(ratings, aes(x = as.factor(episode), y = viewers_7day,
                    group = series)) +
...
```{r groupline, echo = FALSE, out.width='60%'}
# some wrangling here
...
```{r sloperev, echo = FALSE, out.width='65%'}
ggplot(ratings_bonanza4, aes(x = episode, y = viewers_7day,
                             group = series)) +
...
```{r medianbars, echo = FALSE, out.width='70%'}
# some more serious wrangling here
...
ggplot(ratings_bonanza9, aes(x = fct_rev(series), 
  ...
  geom_segment(aes(xend = fct_rev(series), yend = 0), color = bakeoff_cols("riptide")) +
